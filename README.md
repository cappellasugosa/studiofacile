# StudioFacile v11 — Multi-provider AI gratuito
...
## Diagnostica provider
Apri `/api/providers` nel browser per verificare quali chiavi AI sono configurate.
L'endpoint usa GET e non mostra mai i valori delle chiavi: restituisce solo true/false per Gemini, Groq e OpenRouter.
