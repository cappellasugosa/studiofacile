...
## Aggiornamento Gemini 3.6 Flash

Questa versione usa `gemini-3.6-flash` tramite Gemini Interactions API. La chiave resta in Cloudflare come Secret `GEMINI_API_KEY`. Non inserire mai la chiave nel codice o nel repository.
