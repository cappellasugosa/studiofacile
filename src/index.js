...
async function explain(request, env) {
  ...
  const answer = await gemini([{
    type: "text",
    text: `Sei un tutor per studenti delle superiori. Spiega in italiano: ${topic}
Usa linguaggio semplice, esempi, passaggi numerati e termina con "In breve" in 5 punti.`
  }], env);
